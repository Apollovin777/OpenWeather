...
import LocationIq.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("key", (Authentication) new ApiKeyAuth("query", "key"));
